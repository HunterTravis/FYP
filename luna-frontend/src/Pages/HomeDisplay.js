    ...
    <><div className="home">
      ...
      <div className="DisplayContainer">
        ...
        <div className="personal-info">
          ...
          <h3 className="current-class">
            Name: Fatima Jamal</h3>
          <h3 className="current-class">
            Gender: Female</h3>
          <h3 className="current-class">
            DOB:2/17/2002 </h3>
          <h3 className="current-class">
            CNIC: 42101-7940063-8</h3>
          <h3 className="current-class">
            Email: k191107@nu.edu.pk</h3>
          <h3 className="current-class">
            Mobile NO: 0316-8716232</h3>
        </div>
        ...
        <div className="contact-info">
          ...
          <h3 className="current-class">
            Address: FB Area Block 9.</h3>
          <h3 className="current-class">
            Postal code: 85950</h3>
          <h3 className="current-class">
            City: Karachi</h3>
          <h3 className="current-class">
            Country: Pakistan</h3>
        ...
        <div className="family-info">
          ...
          <h3 className="current-class">
            Father's CNIC: 42101-7940063-8</h3>
          <h3 className="current-class">
            Mother's CNIC: 42101-7940063-8</h3>
